...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (no) {
                ...
                case 5 : categoryController.deleteCategory(inputCode()); break;
                default:
    ...
    private static Map<String, String> inputCategory() {
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("카레고리 이름을 입력하세요 : ");
        String name = sc.nextLine();
        System.out.print("상위 카테고리를 입력해주세요 : ");
    ...
    private static Map<String,String> inputModifyCategory() {
        ...
        String name = sc.nextLine();
        System.out.print("수정할 상위 카테고리를 입력해주세요 : ");
        String refCategoryCode = sc.nextLine();
